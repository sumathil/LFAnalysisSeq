...
int main()
{
	...
	double *dPm = new double[56];
	double *dQm = new double[50];
	double *M = new double[106];
	double **J11 = new double *[num_buses-1];
	double **J12 = new double *[num_buses-1];
	double **J21 = new double *[50];
	double **J22 = new double *[50];
	double **J = new double *[106];
	double **JinvG = new double *[106];
	double *X1 = new double[106];
...
initializevector(M,106);
for(int i=0;i<num_buses-1;i++)
{
	M[i]= dPm[i];
}
for (int i=num_buses-1;i<106;i++)
{
...
initializematrix(J12,num_buses-1,50);
mm=0;
nn=0;
for (int i=0;i<num_buses-1;i++)
{
...
initializematrix(J21,50,num_buses-1);
mm =0;
nn =0;
for (int i=0;i<50;i++)
{
...
/*cout<< "Jacobian Part1"<<endl;
  ...
  printmatrix(J12,num_buses-1,50);
  cout<<endl;

  cout<< "Jacobian Part3"<<endl;
  printmatrix(J21,50,num_buses-1);
  cout<<endl;*/
/*
  cout<< "Jacobian Part4"<<endl;
  printmatrix(J22,50,50);
  cout<<endl;*/
//cout<<"For interation= "<<it<<endl<<endl<<endli;

initializematrix(J,106,106);
Jacobian(J,J11,J12,J21,J22,num_buses);
//printmatrix(J,106,106);


//cout<<"For interation= "<<it<<endl<<endl<<endl;
//Inverse through GE method

initializematrix(JinvG,106,106);
InverseGE(JinvG,J,106);
//printmatrix(JinvG,22,22);

initializevector(X1,106);
matvec(X1,JinvG,M,106);
//printvector(X1,106);
...
if (Tol < epsilon)
{
	...
	printvector(busvoltage,num_buses);
	pol2deg(busangle,busangle,num_buses);
...
//loadflow(num_buses,busvoltage,busangle,100);
