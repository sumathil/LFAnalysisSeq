...
int main()
{
	...
	double *dPm = new double[29];
	double *dQm = new double[24];
	double *M = new double[53];
	double **J11 = new double *[num_buses-1];
	double **J12 = new double *[num_buses-1];
	double **J21 = new double *[24];
	double **J22 = new double *[24];
	double **J = new double *[53];
	double **JinvG = new double *[53];
	double *X1 = new double[53];
...
//printvector(dPm,13);
	...
	initializevector(M,53);
	for(int i=0;i<num_buses-1;i++)
	{
		M[i]= dPm[i];
	}
	for (int i=num_buses-1;i<53;i++)
	{
...
initializematrix(J12,num_buses-1,24);
mm=0;
nn=0;
for (int i=0;i<num_buses-1;i++)
{
...
initializematrix(J21,24,num_buses-1);
mm =0;
nn =0;
for (int i=0;i<24;i++)
{
...
/*  cout<< "Jacobian Part2"<<endl;
  printmatrix(J12,num_buses-1,24);
  cout<<endl;

  cout<< "Jacobian Part3"<<endl;
  printmatrix(J21,24,num_buses-1);
  cout<<endl;*/
/*
  cout<< "Jacobian Part4"<<endl;
  printmatrix(J22,24,24);
  cout<<endl;*/
//cout<<"For interation= "<<it<<endl<<endl<<endl;

initializematrix(J,53,53);
...
initializematrix(JinvG,53,53);
InverseGE(JinvG,J,53);
//printmatrix(JinvG,53,53);

initializevector(X1,53);
matvec(X1,JinvG,M,53);
//printvector(X1,53);
